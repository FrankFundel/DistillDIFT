...
parser.add_argument("--dataset_root", type=str, default="/export/group/datasets/co3d", help="Path to CO3D dataset root")
parser.add_argument("--output_root", type=str, default="/export/scratch/ra63des/co3d", help="Output HDF5 file")
